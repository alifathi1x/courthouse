...
class CourthouseDA(Base):
    __tablename__ = "courthouse_tbl"
    _id = Column("id", Integer, primary_key=True, autoincrement=True)
    _judge_name = Column("judge_name", String(30), nullable=False)
    _meeting_date = Column("meeting_date", DateTime, nullable=False)
    _room_number = Column("room_number", Integer, nullable=False)
    _crime_reports = Column("crime_reports", String(100), nullable=False)
